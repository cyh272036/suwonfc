      ...
      <Container className='detail'>
        <Row>
          ...
          <Col md={6} style={{paddingLeft: '30px'}}>
            ...
            <Button variant='light' style={{ width: '100px', height: '50px', border: '1px solid #eee', textAlign: 'center' }}>장바구니</Button>
            <Button variant='primary' style={{ backgroundColor: "#0B1648", border: "none", marginLeft: '10px', width: '100px', height: '50px' }}>주문하기</Button>
          </Col>
        </Row>
